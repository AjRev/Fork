var forkapp = angular.module('fork.controllers', ["firebase", "ionic-modal-select"])
	...
	forkapp.controller('SignUpCtrl', ['$scope', '$rootScope', '$firebaseAuth', '$state', 'UserData', 'CurrUser', function ($scope, $rootScope, $firebaseAuth, $state, UserData, CurrUser) {
      $scope.user = {
        firstname: "",
		surname: "",
		email: "",
...
///////////////////////////////////////////////////////////LIST CONTROLLER//////////////////////////////////////////////////////////////
forkapp.controller('ListCtrl', ['$scope', '$state', '$rootScope', '$ionicHistory', '$firebaseObject', 'CurrUser', '$window', function($scope, $state, $rootScope, $ionicHistory, $firebaseObject, CurrUser, $window) {
...
var userarr = [];
// get event participants using the eventid
